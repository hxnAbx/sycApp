                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../Images/Dibba.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerSeven()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerOne()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    <View style={styles.mainView}>
                        <View style={{ width: '49%' }}>
                            ...
                            <Text style={styles.textStyle}>Dibba Al Hisn Youth Centre</Text>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>Telephone: 092442702</Text> 
                                <Text style={styles.textStyle2}>Email: dibba.alhisn@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                    Dibba Al Hisn Youth Center opened its doors in 2005, and it offers several activities within 
