...
export default class Cerrification extends Component {
    ...
    render() {
        ...
        <Header style={styles.headerStyle}>
                    ...
                    <Body>
                        <Title style={styles.titleStyle}>Feedback History</Title>
                    </Body>
            ...
            >
                ...
                <View style={styles.leftSec}>
                <Text style={styles.trackLABLE}>Status</Text> 
                </View>
                <View style={styles.rightSec}>
                <View style={styles.textContainer}>
                    <Text style={styles.trackerNumber}>Awaiting Response</Text>
                    </View>
