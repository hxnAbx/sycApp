                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../Images/Khorfakkan.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerSix()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerEight()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    <View style={styles.mainView}>
                        <View style={{ width: '49%' }}>
                            ...
                            <Text style={styles.textStyle}>Khorfakkan Youth Centre</Text>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>Telephone: 092385207</Text> 
                                <Text style={styles.textStyle2}>Email: khorfakkan@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                    Khorfakkan Youth Center opened its doors in 2005, and it offers several activities within 
