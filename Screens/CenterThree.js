...
export default class CenterThree extends Component {
    ...
    render() {
        ...
        > 
            <Container>
                <ImageBackground source={require('../Images/Mleiha.jpg')} style={{ flex: 1 }} blurRadius={1.5} >
                    <Header transparent>
                        <Left>
                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../Images/Mleiha.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerTwo()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerFour()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    <View style={styles.mainView}>
                        <View style={{ width: '49%' }}>
                            ...
                            <Text style={styles.textStyle}>Mleiha Youth Centre</Text>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>Telephone: 068838089</Text> 
                                <Text style={styles.textStyle2}>Email: mleiha@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                    Mleiha Youth Center opened its doors in 2004, and it offers several activities within 
