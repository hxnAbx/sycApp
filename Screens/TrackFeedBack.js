...
export default class Cerrification extends Component {
    ...
    render() {
        ...
        <Header style={styles.headerStyle}>
                    ...
                    <Body>
                        <Title style={styles.titleStyle}>Track Feedback</Title>
                    </Body>
                ...
                <View style={styles.leftSec}>
                    <Text style={styles.trackLABLE}>Track number</Text> 
    ...
    borderBottomWidth: 1,width:"100%",height:1,marginTop:20, marginBottom:20}}></View>
            ...
            <View style={styles.formItemWrapper}>
                    <Text style={styles.formLabel}>Message</Text>
                        <View style={styles.textAreaTextView}>
                        <Text style={styles.textAreaText}>Lorem Ipsum is simply dummy text of the printing and type
            ...
            <View style={styles.row}>
            <View style={styles.formItemWrapper}>
                    <Text style={styles.formLabel}>Response</Text>
                        <View style={styles.textAreaTextView}>
                        <Text style={styles.textAreaText}>Lorem Ipsum is simply dummy text of the printing and type
                        Lorem Ipsum is simply dummy text of the printing and type
                        Lorem Ipsum is simply dummy text of the printing and type
