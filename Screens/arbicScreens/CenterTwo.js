...
export default class CenterTwo extends Component {
    closeDrawer() {
    ...
    render() {
        ...
        > 
            <Container>
                <ImageBackground source={require('../../Images/AlDhaid.jpg')} style={{ flex: 1 }} blurRadius={1.5} >
                    <Header transparent>
                        <Left>
                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../../Images/AlDhaid.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerOneAr()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerThreeAr()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    ...
                    <View style={styles.locationView}>
                        ...
                        <View style={{ width: '49%' }}>
                            ...
                            <Text style={styles.textStyle}>مركز ناشئة الذيد</Text>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>الهاتف: 068828968</Text> 
                                <Text style={styles.textStyle2}>البريد الإلكتروني: aldhaid@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                تمّ افتتاح مركز ناشئة الذيد عام 2005، حيث يقدّم العديد من الأنشطة والبرامج، ضمن مسارات أساسيّة هي الآداب واللغات والعلوم والتكنولوجيا وريادة الأعمال والفنون والرّياضة.
