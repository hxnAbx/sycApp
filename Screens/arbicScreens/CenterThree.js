                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../../Images/Mleiha.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerTwoAr()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerFourAr()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    ...
                    <View style={styles.locationView}>
                        ...
                        <View style={{ width: '49%' }}>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>الهاتف: 068838089</Text> 
                                <Text style={styles.textStyle2}>البريد الإلكتروني:  mleiha@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                تمّ افتتاح مركز ناشئة مليحة عام 2004، حيث يقدّم العديد من الأنشطة والبرامج، ضمن مسارات أساسيّة هي الآداب واللغات والعلوم والتكنولوجيا وريادة الأعمال والفنون والرّياضة.
