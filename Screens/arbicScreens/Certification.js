...
export default class Cerrification extends Component {
    ...
    render() {
        ...
        <Header style={styles.headerStyle}>
                    <Left style={{ flex: 0.2 }}>
                    <TouchableOpacity onPress={() => Actions.uploadCertificationAr()}>
                            <Feather type='Feather' name='arrow-left' size={20} color='#323232' />
                        </TouchableOpacity>
                    </Left>
                    <Body>
                        <Title style={styles.titleStyle}>قائمة الشهادات</Title>
                    </Body>
            ...
            <View style={styles.row} >
                <View style={styles.imageViewBOx}>
                            ...
                            <View >
                                ...
                                <Button style={styles.btnStyle} onPress={ this._pickDocumentOne }>
                                    <Text style={styles.btnTextStyle}>شهادة </Text>
                                </Button>                            
                            </View>
                </View>
                <View style={styles.imageViewBOx}>
             ...
             <Button style={styles.mainButton}><Text style={styles.mainButtonText}>إضافة شهادة</Text></Button>
