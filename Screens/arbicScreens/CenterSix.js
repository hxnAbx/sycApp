                    ...
                    <View style={styles.imageView}>                        
                        <ImageBackground source={require('../../Images/Kalba.jpg')} style={styles.imageStyle}>
                            <View style={styles.arrowsView}>
                                <TouchableOpacity onPress={() => Actions.centerFiveAr()} style={styles.touchableArrowStyle}>
                                    <Ionicons type='Ionicons' name='ios-arrow-dropleft-circle' size={22} color="black" />
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => Actions.centerSevenAr()} style={[styles.touchableArrowStyle, { alignItems: 'flex-end' }]}>
                ...
                <Content style={{ marginTop: 20 }}>
                    ...
                    <View style={styles.locationView}>
                        ...
                        <View style={{ width: '49%' }}>
                            ...
                            <Text style={styles.textStyle}>مركز ناشئة كلباء</Text>
                            ...
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>الهاتف: 092774125</Text> 
                                <Text style={styles.textStyle2}>البريد الإلكتروني: kalba@sy.shj.ae</Text> 
                            </View>
                            <View style={{ marginBottom: 15 }}>
                                <Text style={styles.textStyle2}>
                                تمّ افتتاح مركز ناشئة كلباء عام 2005، حيث يقدّم العديد من الأنشطة والبرامج، ضمن مسارات أساسيّة هي الآداب واللغات والعلوم والتكنولوجيا وريادة الأعمال والفنون والرّياضة.
