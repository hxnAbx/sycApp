        ...
        > 
            <Container>
                <Header style={styles.headerStyle}>
                    ...
                    <TouchableOpacity onPress={() => Actions.photoGalleryAr()}>
                            <Feather type='Feather' name='arrow-left' size={20} color='#323232' />
                        </TouchableOpacity>
                    </Left>
                    <Body>
                        <Title style={styles.titleStyle}>الصور</Title>
                    </Body>
                ...
                <ImageBackground resizeMode='cover' source={require('../../Images/galleryPic1.png')} style={styles.imagesView}>
                    ...
                    <View style={styles.imageTitleView}>
                        <Text style={styles.textStyle}>مشاركة الناشئة في برنامج مغامرات الناشئة</Text>
                    </View>
                </ImageBackground>
