...
export default class Cerrification extends Component {
    ...
    render() {
        ...
        <Header style={styles.headerStyle}>
                    ...
                    <Body>
                        <Title style={styles.titleStyle}>فئات الأحداث</Title>
                    </Body>
                ...
                <View style={styles.bgBox}>
                    <Text style={styles.bgBoxText}>يوم مفتوح</Text>
                </View>
                    <View style={styles.bgBox}>
                    <Text style={styles.bgBoxText}>تدريب الفريق</Text>
                    </View>
                </View>
                <View style={styles.row}>
                <View style={styles.bgBox}>
                <Text style={styles.bgBoxText}>رياضات</Text>
                </View>
                    <View style={styles.bgBox}>
                    <Text style={styles.bgBoxText}>الجائزة الثقافية</Text>
                    </View>
                </View>
