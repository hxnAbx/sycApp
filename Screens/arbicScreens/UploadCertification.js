...
export default class UploadCertification extends Component {
    ...
    render() {
        ...
        <Header style={styles.headerStyle}>
                    <Left style={{ flex: 0.2 }}>
                    <TouchableOpacity onPress={() => Actions.profileAr()}>
                            <Feather type='Feather' name='arrow-left' size={20} color='#323232' />
                        </TouchableOpacity>
                    </Left>
                    <Body>
                        <Title style={styles.titleStyle}>إضافة شهادة </Title>
                    </Body>
                ...
                <View style={styles.formItemWrapper}>
                    <Text style={styles.formLabel}>إجمالي المجال</Text>
                    ...
                    <View style={styles.pickerView}>
                        <Picker
                         ...
                         >
                            <Picker.Item label="أدخل النص" value="Domain1" />
                            <Picker.Item label="أدخل النص" value="Domain2" />
                        </Picker>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.formItemWrapper}>
                    ...
                    <View style={styles.pickerView}>
                        <Picker
                         ...
                         >
                            <Picker.Item label="اختر الفئة" value="Category1" />
                            <Picker.Item label="اختر الفئة" value="Category2" />
                        </Picker>
                        </View>
                    </View>
                </View>
                ...
                <View style={styles.formItemWrapper}>
                    <Text style={styles.formLabel}>عنوان</Text>
                ...
                <View style={styles.formItemWrapper}>
                    <Text style={styles.formLabel}>رفع</Text>

                    <View style={styles.uploadCertiArea} >
                        <TouchableOpacity onPress={()=> Actions.certificationAr()}>
